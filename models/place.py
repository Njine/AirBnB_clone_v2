...
class Place(BaseModel, Base):
    ...
    Attributes:
        ...
        amenities: Relationship with Amenity class through place_amenity
    """
    ...
    if getenv("HBNB_TYPE_STORAGE") == "db":
        ...
        @property
        def reviews(self):
            """Returns list of reviews related to the place"""
        ...
        @property
        def amenities(self):
            """Returns list of amenity ids related to the place"""
