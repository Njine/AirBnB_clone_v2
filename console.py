...
class HBNBCommand(cmd.Cmd):
    ...
    def do_update(self, args):
        cls_name, _, args = args.partition(" ")
        obj_id, _, attr_val = args.partition(" ")
        att_name, _, attr_val = attr_val.partition(" ")
        ...
        if '{' in attr_val and '}' in attr_val:
            ...
            if att_name in HBNBCommand.types:
                attr_val = HBNBCommand.types[att_name](attr_val)

            storage.all()[key].__dict__.update({att_name: attr_val})
